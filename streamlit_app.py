...
# Ensure unique key for API key input
def get_openai_api_key():
    return st.text_input('Enter OpenAI API Key:', type='password', key='api_key_input')

# Sidebar input to choose API key, model, and parameters
with st.sidebar:
...
# Chat input, only enabled when the API key is entered
if api_key:
